...
init_test()
{
	...
	LD_PRELOAD="$libpath" $exec_name &>> $LOG_FILE &
...
test_fun_array=(								\
	...
	test_uses_sendfile "Test sendfile uses" 2
	test_get_small_file_wget "Test small file wget" 2
	test_get_small_file_wget_cmp "Test small file wget cmp" 5
	test_get_large_file_wget "Test large file wget" 2
	test_get_large_file_wget_cmp "Test large file wget cmp" 5
	...
	test_uses_io_submit "Test io submit uses" 2
	test_get_small_dyn_file_wget "Test small dynamic file wget" 2
	test_get_small_dyn_file_wget_cmp "Test small dynamic file wget cmp" 5
	test_get_large_dyn_file_wget "Test large dynamic file wget" 2
	...
	test_get_mul_sim_dyn_files "Test multiple simultaneous dynamic files" 6
