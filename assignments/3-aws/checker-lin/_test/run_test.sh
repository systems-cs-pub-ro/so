...
test_fun_array=( \
	test_executable_exists "Test executable exists" 2 0
	test_executable_runs "Test executable runs" 2 0
	test_is_listening "Test listening" 2 0
	test_is_listening_on_port "Test listening on port" 2 0
	test_accepts_connections "Test accepts connections" 2 0
